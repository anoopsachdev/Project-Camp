...
const registerUser = asyncHandler(async (req, res) => {
  ...
  await sendEmail({
    ...
    mailgenContent: emailVerificationMailgenContent(
      ...
      // req.get('host') -> localhost, chaicode.com, example.com
    ),
  });
...
const verifyEmail = asyncHandler(async (req, res) => {
  ...
  user.emailVerificationToken = undefined; // not necessary to do but recommended not to keep data which is now useless in the database
  user.emailVerificationExpiry = undefined; // same for the above comment
...
const resetForgotPassword = asyncHandler(async (req, res) => {
  ...
  user.password = newPassword; // the pre-hook would run and hash the password
  await user.save({ validateBeforeSave: false });
